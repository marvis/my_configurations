...
echo '	'
echo '  glRotatef(rtri,0.0f,1.0f,0.0f);		// Rotate The Pyramid On The Y axis '
echo ''
echo '  // draw a pyramid (in smooth coloring mode)'
echo '  glBegin(GL_POLYGON);				// start drawing a pyramid'
echo ''
echo '  // front face of pyramid'
echo '  glColor3f(1.0f,0.0f,0.0f);			// Set The Color To Red'
echo '  glVertex3f(0.0f, 1.0f, 0.0f);		        // Top of triangle (front)'
echo '  glColor3f(0.0f,1.0f,0.0f);			// Set The Color To Green'
echo '  glVertex3f(-1.0f,-1.0f, 1.0f);		// left of triangle (front)'
echo '  glColor3f(0.0f,0.0f,1.0f);			// Set The Color To Blue'
echo '  glVertex3f(1.0f,-1.0f, 1.0f);		        // right of traingle (front)	'
echo ''
echo '  // right face of pyramid'
echo '  glColor3f(1.0f,0.0f,0.0f);			// Red'
echo '  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Right)'
echo '  glColor3f(0.0f,0.0f,1.0f);			// Blue'
echo '  glVertex3f( 1.0f,-1.0f, 1.0f);		// Left Of Triangle (Right)'
echo '  glColor3f(0.0f,1.0f,0.0f);			// Green'
echo '  glVertex3f( 1.0f,-1.0f, -1.0f);		// Right Of Triangle (Right)'
echo ''
echo '  // back face of pyramid'
echo '  glColor3f(1.0f,0.0f,0.0f);			// Red'
echo '  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Back)'
echo '  glColor3f(0.0f,1.0f,0.0f);			// Green'
echo '  glVertex3f( 1.0f,-1.0f, -1.0f);		// Left Of Triangle (Back)'
echo '  glColor3f(0.0f,0.0f,1.0f);			// Blue'
echo '  glVertex3f(-1.0f,-1.0f, -1.0f);		// Right Of Triangle (Back)'
echo ''
echo '  // left face of pyramid.'
echo '  glColor3f(1.0f,0.0f,0.0f);			// Red'
echo '  glVertex3f( 0.0f, 1.0f, 0.0f);		// Top Of Triangle (Left)'
echo '  glColor3f(0.0f,0.0f,1.0f);			// Blue'
echo '  glVertex3f(-1.0f,-1.0f,-1.0f);		// Left Of Triangle (Left)'
echo '  glColor3f(0.0f,1.0f,0.0f);			// Green'
echo '  glVertex3f(-1.0f,-1.0f, 1.0f);		// Right Of Triangle (Left)'
echo ''
echo '  glEnd();					// Done Drawing The Pyramid'
echo ''
echo '  glLoadIdentity();				// make sure we'"'"'re no longer rotated.'
echo '  glTranslatef(1.5f,0.0f,-7.0f);		// Move Right 3 Units, and back into the screen 7'
echo '	'
echo '  glRotatef(rquad,1.0f,1.0f,1.0f);		// Rotate The Cube On X, Y, and Z'
echo ''
echo '  // draw a cube (6 quadrilaterals)'
echo '  glBegin(GL_QUADS);				// start drawing the cube.'
echo '  '
echo '  // top of cube'
echo '  glColor3f(0.0f,1.0f,0.0f);			// Set The Color To Blue'
echo '  glVertex3f( 1.0f, 1.0f,-1.0f);		// Top Right Of The Quad (Top)'
echo '  glVertex3f(-1.0f, 1.0f,-1.0f);		// Top Left Of The Quad (Top)'
echo '  glVertex3f(-1.0f, 1.0f, 1.0f);		// Bottom Left Of The Quad (Top)'
echo '  glVertex3f( 1.0f, 1.0f, 1.0f);		// Bottom Right Of The Quad (Top)'
echo ''
echo '  // bottom of cube'
echo '  glColor3f(1.0f,0.5f,0.0f);			// Set The Color To Orange'
echo '  glVertex3f( 1.0f,-1.0f, 1.0f);		// Top Right Of The Quad (Bottom)'
echo '  glVertex3f(-1.0f,-1.0f, 1.0f);		// Top Left Of The Quad (Bottom)'
echo '  glVertex3f(-1.0f,-1.0f,-1.0f);		// Bottom Left Of The Quad (Bottom)'
echo '  glVertex3f( 1.0f,-1.0f,-1.0f);		// Bottom Right Of The Quad (Bottom)'
echo ''
echo '  // front of cube'
echo '  glColor3f(1.0f,0.0f,0.0f);			// Set The Color To Red'
echo '  glVertex3f( 1.0f, 1.0f, 1.0f);		// Top Right Of The Quad (Front)'
echo '  glVertex3f(-1.0f, 1.0f, 1.0f);		// Top Left Of The Quad (Front)'
echo '  glVertex3f(-1.0f,-1.0f, 1.0f);		// Bottom Left Of The Quad (Front)'
echo '  glVertex3f( 1.0f,-1.0f, 1.0f);		// Bottom Right Of The Quad (Front)'
echo ''
echo '  // back of cube.'
echo '  glColor3f(1.0f,1.0f,0.0f);			// Set The Color To Yellow'
echo '  glVertex3f( 1.0f,-1.0f,-1.0f);		// Top Right Of The Quad (Back)'
echo '  glVertex3f(-1.0f,-1.0f,-1.0f);		// Top Left Of The Quad (Back)'
echo '  glVertex3f(-1.0f, 1.0f,-1.0f);		// Bottom Left Of The Quad (Back)'
echo '  glVertex3f( 1.0f, 1.0f,-1.0f);		// Bottom Right Of The Quad (Back)'
echo ''
echo '  // left of cube'
echo '  glColor3f(0.0f,0.0f,1.0f);			// Blue'
echo '  glVertex3f(-1.0f, 1.0f, 1.0f);		// Top Right Of The Quad (Left)'
echo '  glVertex3f(-1.0f, 1.0f,-1.0f);		// Top Left Of The Quad (Left)'
echo '  glVertex3f(-1.0f,-1.0f,-1.0f);		// Bottom Left Of The Quad (Left)'
echo '  glVertex3f(-1.0f,-1.0f, 1.0f);		// Bottom Right Of The Quad (Left)'
echo ''
echo '  // Right of cube'
echo '  glColor3f(1.0f,0.0f,1.0f);			// Set The Color To Violet'
echo '  glVertex3f( 1.0f, 1.0f,-1.0f);	        // Top Right Of The Quad (Right)'
echo '  glVertex3f( 1.0f, 1.0f, 1.0f);		// Top Left Of The Quad (Right)'
echo '  glVertex3f( 1.0f,-1.0f, 1.0f);		// Bottom Left Of The Quad (Right)'
echo '  glVertex3f( 1.0f,-1.0f,-1.0f);		// Bottom Right Of The Quad (Right)'
echo '  glEnd();					// Done Drawing The Cube'
echo ''
echo '  rtri+=15.0f;					// Increase The Rotation Variable For The Pyramid'
echo '  rquad-=15.0f;					// Decrease The Rotation Variable For The Cube'
echo ''
...
echo '{'
echo '    /* avoid thrashing this call */'
echo '    usleep(100);'
echo ''
...
echo '     Depth buffered for automatic clipping */  '
