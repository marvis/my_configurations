...
echo ''
echo 'GLfloat	rtri;			// Angle For The Triangle ( NEW )'
echo 'GLfloat	rquad;			// Angle For The Quad ( NEW )'
echo ''
echo '// Main ----------------------------------------------------------------------'
echo ''
...
echo 'GLvoid Idle(GLvoid)'
echo '{'
echo '	rtri += 0.2;						// Increase The Rotation Variable For The Triangle ( NEW )'
echo '	rquad -= 0.15;						// Decrease The Rotation Variable For The Quad ( NEW )'
echo '	'
...
echo '	glRotatef(rtri,0.0f,1.0f,0.0f);				// Rotate The Triangle On The Y axis ( NEW )'
...
echo '	glRotatef(rquad,1.0f,0.0f,0.0f);			// Rotate The Quad On The X axis ( NEW )'
