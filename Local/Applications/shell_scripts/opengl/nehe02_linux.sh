...
echo '  glEnd();					// we'"'"'re done with the polygon'
echo ''
echo '  glTranslatef(3.0f,0.0f,0.0f);		        // Move Right 3 Units'
echo '	'
...
echo ''
echo '  // swap buffers to display, since we'"'"'re double buffered.'
...
echo ''
echo '  /* Go fullscreen.  This is the soonest we could possibly go fullscreen. */'
echo '  glutFullScreen();'
echo ''
