...
echo ''
echo 'GLfloat	rtri;			// Angle For The Triangle'
echo 'GLfloat	rquad;			// Angle For The Quad'
echo ''
echo '// Main ----------------------------------------------------------------------'
echo ''
...
echo 'GLvoid Idle(GLvoid)'
echo '{'
echo '	rtri += 0.2f;							// Increase The Rotation Variable For The Triangle '
echo '	rquad -= 0.15f;							// Decrease The Rotation Variable For The Quad '
echo '	'
...
echo '	glTranslatef(-1.5f,0.0f,-6.0f);				// Move Left And Into The Screen'
echo ''
echo '	glRotatef(rtri,0.0f,1.0f,0.0f);				// Rotate The Pyramid On It'"'"'s Y Axis'
echo ''
echo '	glBegin(GL_POLYGON);					// Start Drawing The Pyramid						'
...
echo '		glVertex3f( 1.0f,-1.0f, 1.0f);			// Right Of Triangle (Front)'
echo '	'
echo '		glColor3f(1.0f,0.0f,0.0f);				// Red'
...
echo '	glEnd();								// Done Drawing Pyramid'
echo '	'
echo '	glLoadIdentity();'
echo '	glTranslatef(1.5f,0.0f,-7.0f);				// Move Right And Into The Screen'
echo ''
echo '	glRotatef(rquad,1.0f,1.0f,1.0f);			// Rotate The Cube On X, Y & Z'
echo ''
...
echo '	glEnd();								// Done Drawing The Quad'
echo '	'
