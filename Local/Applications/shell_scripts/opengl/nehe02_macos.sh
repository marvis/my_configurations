...
echo '    glutInitDisplayMode (GLUT_SINGLE | GLUT_RGB | GLUT_DEPTH);'
...
echo ''
echo '	glTranslatef(-1.5f,0.0f,-6.0f);'
echo ''
echo '	glBegin(GL_POLYGON);'
echo '		glVertex3f( 0.0f, 1.0f, 0.0f);'
echo '		glVertex3f(-1.0f,-1.0f, 0.0f);'
echo '		glVertex3f( 1.0f,-1.0f, 0.0f);'
echo '	glEnd();'
echo ''
echo '	glTranslatef(3.0f,0.0f,0.0f);'
echo ''
