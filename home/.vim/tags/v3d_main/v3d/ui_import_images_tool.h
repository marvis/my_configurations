...
public:
    ...
    void setupUi(QDialog *import_images_tool)
    {
        ...
        import_images_tool->resize(319, 325);
        layoutWidget = new QWidget(import_images_tool);
        layoutWidget->setObjectName(QString::fromUtf8("layoutWidget"));
        layoutWidget->setGeometry(QRect(21, 21, 273, 277));
    ...
    void retranslateUi(QDialog *import_images_tool)
    {
        ...
        startimgButton->setText(QApplication::translate("import_images_tool", "Starting Image", 0, QApplication::UnicodeUTF8));
