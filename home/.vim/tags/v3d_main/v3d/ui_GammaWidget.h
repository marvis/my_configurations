...
public:
    ...
    void setupUi(QWidget *GammaWidget)
    {
        ...
        gamma_slider->setMinimum(-300);
        gamma_slider->setMaximum(300);
        gamma_slider->setSingleStep(10);
        gamma_slider->setPageStep(50);
        gamma_slider->setOrientation(Qt::Horizontal);
        gamma_slider->setTickPosition(QSlider::TicksBelow);
        gamma_slider->setTickInterval(300);
        ...
        gamma_lineEdit->setMaximumSize(QSize(50, 16777215));
